...
if (isset($_POST['update_preorder'])) {
   ...
   header('Location: staff_pending_preorders.php');
   exit;
}
...
<head>
   ...
   <title>Staff Pending Pre-Orders</title>
...
<body>
   ...
   <section class="placed-orders">
      ...
      <h1 class="title">Pending Pre-Orders</h1>
      ...
      <div class="box-container">
         ...
         <?php
            ...
            echo '<p class="empty">No pending pre-orders found!</p>';
         }
         ?>

...
if (isset($_POST['update_reservation'])) {
   ...
   header('Location: staff_confirmed_reservation.php');
   exit;
}
...
<head>
   ...
   <title>Staff Confirmed Reservations</title>
...
<body>
   ...
   <section class="placed-orders">
      ...
      <h1 class="title">Confirmed Reservations</h1>
      ...
      <div class="box-container">
         ...
         <?php
            ...
            echo '<p class="empty">No confirmed reservations found!</p>';
         }
         ?>

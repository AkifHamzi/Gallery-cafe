      ...
      <form action="" method="POST" enctype="multipart/form-data">
         ...
         <div class="flex">
            ...
            <div class="inputBox">
               ...
               <input type="password" name="update_pass" placeholder="enter previous password" minlength="5" class="box">
               <span>new password :</span>
               <input type="password" name="new_pass" minlength="5" placeholder="enter new password" class="box">

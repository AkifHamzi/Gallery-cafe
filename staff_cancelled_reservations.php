...
if (isset($_POST['update_reservation'])) {
   ...
   header('Location: staff_cancelled_reservations.php');
   exit;
}
...
<head>
   ...
   <title>Staff Cancelled Reservations</title>
...
<body>
   ...
   <section class="placed-orders">
      ...
      <h1 class="title">Cancelled Reservations</h1>
      ...
      <div class="box-container">
         ...
         <?php
            ...
            echo '<p class="empty">No cancelled reservations found!</p>';
         }
         ?>

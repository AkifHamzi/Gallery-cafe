...
<head>
    ...
    <title>Staff Cancelled Car Reservations</title>
...
<body>
    ...
    <section class="placed-orders">
        ...
        <h1 class="title">Cancelled Car Reservations</h1>

        <div class="box-container">

            <?php
            $select_reservations = $conn->prepare("SELECT * FROM `car_reservations` WHERE reservation_status = 'cancelled'");
            ...
            <?php
                ...
                echo '<p class="empty">No cancelled car reservations found!</p>';
            }
            ?>

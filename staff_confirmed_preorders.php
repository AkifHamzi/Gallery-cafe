...
if (isset($_POST['update_preorder'])) {
   ...
   header('Location: staff_confirmed_preorders.php');
   exit;
}
...
<head>
   ...
   <title>Staff Confirmed Pre-Orders</title>
...
<body>
   ...
   <section class="placed-orders">
      ...
      <h1 class="title">Confirmed Pre-Orders</h1>
      ...
      <div class="box-container">
         ...
         <?php
            ...
            echo '<p class="empty">No confirmed pre-orders found!</p>';
         }
         ?>

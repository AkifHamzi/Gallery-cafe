   ...
   <header class="header staff">
      ...
      <div class="flex">
         ...
         <div class="profile">
            ...
            if (isset($admin_id)) {
               $user_id = $admin_id;
               $update_profile_url = 'admin_update_profile.php';
            } elseif (isset($staff_id)) {
               $user_id = $staff_id;
               $update_profile_url = 'staff_update_profile.php';
            }
            ...
            <a href="<?= $update_profile_url ?>" class="btn">update profile</a>
            <?php if (isset($admin_id)) : ?>
               <a href="admin_page.php" class="btn">Admin Dashboard</a>
            <?php endif; ?>
